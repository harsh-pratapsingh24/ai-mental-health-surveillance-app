...
const STRINGS = {
  en: {
    ...
    weather_tag: "Emotional Horizon",
    sanctuary_title: "Calming Sanctuary",

    // Toolkit Items
    tool_companion: "AI Companion",
    tool_companion_sub: "Talk & console",
    tool_sanctuary: "Calm Sanctuary",
    tool_sanctuary_sub: "Coping & solace",
    ...
    chat_welcome:
      "Hello friend. I am here to listen, support, and console you without any judgment. How are you feeling right now?",
    ...
    btn_got_it: "Got It",
    def_dpi:
      "DPI (Distress Prediction Index) is a composite number from 0.0 to 1.0 reflecting your current emotional load based on your journal words, mood sliders, and voice clarity. Lower numbers mean higher calm.",
    def_delta:
      "Trajectory Velocity (ΔDPI) tracks the direction and speed of emotional change over time. A flat or downward slope shows increasing calm, while a steep rise flags potential fatigue.",
    def_pronoun:
      'Pronoun Density measures how often first-person words ("I", "me", "my") appear. Research shows that when we feel overwhelmed, our attention naturally shifts inward.',
    def_absolute:
      'Absolutist Words are all-or-nothing terms like "always", "never", or "nothing". In Cognitive Behavioral Therapy (CBT), noticing these helps develop gentle, balanced perspectives.',
    def_valence:
      "Valence measures whether an emotion feels heavy or pleasant (1 to 5). Arousal measures your physiological energy level from calm (1) to restless (5).",
    ...
    insight_low_text:
      "Your distress indicators are calm and steady. Keep up your mindful habits.",
    insight_moderate_title: "Checking in with you",
    insight_moderate_text:
      "We noticed some subtle tension in your recent entries. Take a quiet moment to rest.",
    insight_critical_title: "We're here for you",
    insight_critical_text:
      "Your wellbeing is important. Please use our Help button or reach out to a counselor.",
    insight_neutral_title: "Welcome to AegisMind",
    insight_neutral_text:
      "Complete your first check-in to begin tracking your wellness journey.",
    ...
    recommendation_low:
      "Practice 5-4-3-2-1 sensory grounding: 5 things you see, 4 you can touch, 3 you hear, 2 you smell, 1 you taste.",
    recommendation_moderate:
      "Consider resting or talking to our AI Companion. A counselor has also been notified to support you.",
    recommendation_critical:
      "Your safety is deeply valued. Please contact a helpline immediately or use the emergency breathing pacer.",

    // Crisis
    crisis_title: "Support Is Available",
    crisis_subtitle:
      "You are not alone. Please reach out to trained support counselors 24/7.",
    ...
    consent_subtitle:
      "AegisMind provides confidential mental health support and distress prediction.",
    consent_anon: "Anonymized Session",
    consent_anon_text:
      "All data is processed under a random anonymous token without personal identity tracking.",
    consent_zk: "Private Text Processing",
    consent_zk_text:
      "Your journals are evaluated locally and in memory. Raw text is never retained beyond your session.",
    consent_crisis: "Emergency Escalation",
    consent_crisis_text:
      "If severe distress is detected, emergency helpline options and counselor support are provided.",
  ...
  hi: {
    ...
    weather_tag: "भावनात्मक क्षितिज",
    sanctuary_title: "शांति एवं राहत कक्ष",

    tool_companion: "AI साथी",
    tool_companion_sub: "बातचीत व सांत्वना",
    tool_sanctuary: "शांति कक्ष",
    tool_sanctuary_sub: "राहत और सांत्वना",
    ...
    chat_welcome:
      "नमस्ते मित्र। मैं यहाँ बिना किसी निर्णय के आपकी बात सुनने और सांत्वना देने के लिए हूँ। आप अभी कैसा महसूस कर रहे हैं?",
    ...
    def_dpi:
      "DPI (संकट पूर्वानुमान सूचकांक) 0.0 से 1.0 तक का एक समग्र स्कोर है जो आपके जर्नल के शब्दों, मनोदशा और आवाज़ के आधार पर मानसिक तनाव को दर्शाता है। कम अंक मन की शांति दर्शाते हैं।",
    def_delta:
      "प्रक्षेपवक्र वेग (ΔDPI) समय के साथ आपकी मनोदशा में आ रहे बदलाव की दिशा और गति को मापता है। स्थिर या नीचे की ओर ढलान मानसिक सुधार का संकेत है।",
    def_pronoun:
      'सर्वनाम घनत्व यह मापता है कि आप "मैं", "मुझे", "मेरा" जैसे शब्दों का कितना उपयोग करते हैं। जब कोई तनाव में होता है तो उसका ध्यान स्वाभाविक रूप से अंदर की ओर केंद्रित होता है।',
    def_absolute:
      'निरपेक्ष शब्द "हमेशा", "कभी नहीं", "कुछ नहीं" जैसे शब्द होते हैं। संज्ञानात्मक व्यवहार थेरेपी (CBT) में इन्हें पहचानना संतुलित सोच विकसित करने में मदद करता है।',
    def_valence:
      "संयोजकता मापती है कि भावना भारी है या सुखद (1 से 5)। उत्तेजना आपके ऊर्जा स्तर को शांत (1) से बेचैन (5) तक मापती है।",
    ...
    insight_low_text:
      "आपके मानसिक संकेतक शांत और स्थिर हैं। अपनी अच्छी दिनचर्या बनाए रखें।",
    insight_moderate_title: "आपकी जाँच कर रहे हैं",
    insight_moderate_text:
      "आपकी प्रविष्टियों में थोड़ा तनाव दिखा है। कुछ समय शांति से आराम करें।",
    insight_critical_title: "हम आपके साथ हैं",
    insight_critical_text:
      "आपकी सुरक्षा सबसे महत्वपूर्ण है। कृपया सहायता बटन दबाएं या परामर्शदाता से बात करें।",
    insight_neutral_title: "AegisMind में आपका स्वागत है",
    insight_neutral_text:
      "अपनी स्वास्थ्य यात्रा शुरू करने के लिए पहला चेक-इन पूरा करें।",
    ...
    recommendation_low:
      "5-4-3-2-1 तकनीक अपनाएं: 5 चीज़ें देखें, 4 छुएं, 3 सुनें, 2 सूंघें, 1 चखें।",
    recommendation_moderate:
      "हमारे AI साथी से बात करें या आराम करें। सहायता के लिए परामर्शदाता को सूचित किया गया है।",
    recommendation_critical:
      "आपकी जान अनमोल है। कृपया तुरंत हेल्पलाइन से संपर्क करें या 4-7-8 श्वास व्यायाम करें।",

    crisis_title: "सहायता उपलब्ध है",
    crisis_subtitle:
      "आप अकेले नहीं हैं। प्रशिक्षित परामर्शदाता 24/7 आपकी मदद के लिए उपलब्ध हैं।",
    ...
    consent_subtitle:
      "AegisMind गोपनीय मानसिक स्वास्थ्य निगरानी और सहायता प्रदान करता है।",
    consent_anon: "अनामीकृत सत्र",
    consent_anon_text:
      "सभी डेटा बिना किसी व्यक्तिगत पहचान के यादृच्छिक टोकन के तहत संसाधित होता है।",
    consent_zk: "निजी पाठ प्रसंस्करण",
    consent_zk_text:
      "आपकी जर्नल प्रविष्टियां सुरक्षित रूप से विश्लेषित होती हैं और कभी बेची नहीं जातीं।",
    consent_crisis: "आपातकालीन सहायता",
    consent_crisis_text:
      "गंभीर तनाव में आपातकालीन हेल्पलाइन विकल्प प्रदान किए जाते हैं।",
...
const AFFIRMATIONS = [
  ...
  {
    text: "Breathe. You are doing much better than you give yourself credit for.",
    author: "Mindfulness Practice",
  },
  {
    text: "This feeling is temporary. You have survived 100% of your hardest days so far.",
    author: "Resilience Anchor",
  },
  {
    text: "Your present situation is not your final destination. Take it one breath at a time.",
    author: "CBT Reframing",
  },
  {
    text: "Peace comes from within. Give yourself permission to slow down today.",
...
const GROUNDING_STEPS = [
  {
    num: 5,
    title: "Sight",
    desc: "Look around and acknowledge 5 things you can see right now (e.g. a color, a pattern, an object).",
  },
  {
    num: 4,
    title: "Touch",
    desc: "Acknowledge 4 things you can physically feel (e.g. the chair beneath you, the fabric of your clothes).",
  },
  {
    num: 3,
    title: "Hearing",
    desc: "Listen carefully and acknowledge 3 distinct sounds around you or in the distance.",
  },
  {
    num: 2,
    title: "Smell",
    desc: "Acknowledge 2 things you can smell, or 2 soothing scents you like (e.g. rain, coffee, lavender).",
  },
  {
    num: 1,
    title: "Taste",
    desc: "Acknowledge 1 thing you can taste, or take a slow, mindful sip of fresh water.",
  },
];
...
// Central request boundary: consistent JSON, timeouts, and actionable errors.
// Replace API_BASE_URL when the Flask app is deployed behind a separate gateway.
const API_BASE_URL = window.AEGIS_API_BASE_URL || "";
async function apiRequest(path, options = {}) {
  ...
  try {
    ...
    if (!response.ok) {
      throw new ApiError(
        payload.message || payload.error || "Unable to complete that request.",
        response.status,
      );
    }
    return payload;
...
function applyLanguage() {
  ...
  if (curLang)
    curLang.textContent = State.lang === "en" ? "English (EN)" : "हिन्दी (HI)";
  updateHomeGreeting();
  saveState();
}
...
function toggleLanguage() {
  ...
  applyLanguage();
  showToast(
    State.lang === "hi" ? "भाषा: हिन्दी" : "Language: English",
    "info",
    2000,
  );
}
...
async function acceptConsent() {
  try {
    ...
    showToast(
      error.message || "Could not create a private session. Please try again.",
      "error",
      5000,
    );
    return;
...
function updateGroundingView() {
  ...
  $("grounding-prev-btn").style.display =
    currentGroundingIdx === 0 ? "none" : "block";
  $("grounding-next-btn").textContent =
    currentGroundingIdx === GROUNDING_STEPS.length - 1
      ? t("btn_finish")
      : t("btn_next");
}
...
// ────────────────────────────────────────────────────────────────
const VALENCE_DESCRIPTORS = {
  en: {
    1: "Deep Distress", 2: "Acute Heaviness", 3: "Down / Depressed", 4: "Low Mood",
    5: "Balanced / Neutral", 6: "Calm & Steady", 7: "Content", 8: "Bright & Uplifted",
    9: "Energized Joy", 10: "Radiant Bliss"
  },
  hi: {
    1: "गहरा अवसाद", 2: "गंभीर तनाव", 3: "उदासी / भारीपन", 4: "कम ऊर्जा",
    5: "संतुलित / सामान्य", 6: "शांत व स्थिर", 7: "संतुष्ट", 8: "उत्साहित व प्रसन्न",
    9: "आनंदित", 10: "परमानंद"
  }
};

const AROUSAL_DESCRIPTORS = {
  en: {
    1: "Drained / Exhausted", 2: "Deep Fatigue", 3: "Sluggish", 4: "Sedate / Relaxed",
    5: "Balanced Focus", 6: "Awake & Alert", 7: "Restless Energy", 8: "High Tension",
    9: "Agitated", 10: "Hyper-Aroused"
  },
  hi: {
    1: "पूरी तरह थका हुआ", 2: "गंभीर थकान", 3: "सुस्त / धीमा", 4: "शांत",
    5: "संतुलित ऊर्जा", 6: "जागरूक व सजग", 7: "हल्की बेचैनी", 8: "तनावग्रस्त",
    9: "अत्यधिक बेचैन", 10: "उत्तेजित / घबराहट"
  }
};
...
function initSliders() {
  $$(".mood-slider").forEach((slider) => {
    ...
    function update() {
      ...
      const val = Math.round(parseFloat(slider.value) || 5);
      const pct = ((val - min) / (max - min)) * 100;
      slider.style.setProperty("--pct", `${pct}%`);
      if (valueEl) valueEl.textContent = val;

      const lang = State.lang === "hi" ? "hi" : "en";
      if (slider.id === "valence-slider") {
        const tag = $("valence-mood-tag");
        if (tag) tag.textContent = (VALENCE_DESCRIPTORS[lang] && VALENCE_DESCRIPTORS[lang][val]) || "";
      } else if (slider.id === "arousal-slider") {
        const tag = $("arousal-mood-tag");
        if (tag) tag.textContent = (AROUSAL_DESCRIPTORS[lang] && AROUSAL_DESCRIPTORS[lang][val]) || "";
      }
    }
...
async function submitCheckin() {
  ...
  try {
    ...
    // Never synthesize a clinical score after the server rejects or loses a
    // request. The person should only see an evaluated result from the safety
    // pipeline.
    showToast(
      error.message ||
        "Your check-in could not be processed. Please try again.",
      "error",
      5000,
    );
  } finally {
...
function resetCheckinForm() {
  ...
  $("valence-slider").value = 5;
  $("arousal-slider").value = 5;
  initSliders();
...
function updateHome() {
  ...
  const avgDPI = count
    ? (State.history.reduce((a, h) => a + (h.dpi || 0), 0) / count).toFixed(2)
    : "—";
...
function updateEmotionalWeather() {
  ...
  if (count === 0) {
    iconEl.textContent = "🌅";
    statusEl.textContent = lang === "hi" ? "शांत प्रभात" : "Gentle Sunrise";
    descEl.textContent = lang === "hi"
      ? "आज आपका मानसिक क्षितिज शांत है। पहला चेक-इन दर्ज करें।"
      : "Your mental baseline is calm. Take a quiet breath and start your check-in.";
    return;
  }

  const latest = State.history[count - 1];
  const dpi = typeof latest.dpi === "number" ? latest.dpi : 0.2;

  if (dpi >= 0.70) {
    iconEl.textContent = "🌧️";
    statusEl.textContent = lang === "hi" ? "तूफानी लहर" : "Storm Gathering";
    descEl.textContent = lang === "hi"
      ? "मानसिक दबाव अधिक है। कृपया शांति कक्ष या संकट हेल्पलाइन की सहायता लें।"
      : "Emotional load is heavy right now. Step into the Calm Sanctuary or call 14416.";
  } else if (dpi >= 0.40) {
    iconEl.textContent = "⛅";
    statusEl.textContent = lang === "hi" ? "धुंधले बादल" : "Passing Mist";
    descEl.textContent = lang === "hi"
      ? "हल्का तनाव मौजूद है। कुछ मिनट का आराम और गहरी सांसें आपको राहत देंगी।"
      : "Some emotional tension is present. A gentle 5-minute pause will help rebalance.";
  } else {
    iconEl.textContent = "☀️";
    statusEl.textContent = lang === "hi" ? "स्वच्छ क्षितिज" : "Clear Horizon";
    descEl.textContent = lang === "hi"
      ? "आपकी मनोदशा संतुलित और शांत है। इस संतुलन का आनंद लें।"
      : "Your baseline is steady and grounded. Keep nurturing your peaceful rhythm.";
  }
}

// ────────────────────────────────────────────────────────────────
// CALMING SANCTUARY & CONSOLING HUB CONTROLLER
// ────────────────────────────────────────────────────────────────
function switchSanctuaryTab(tab) {
  const tabs = ["tipp", "defusion", "tapping", "guides"];
  tabs.forEach((tId) => {
    const tabBtn = $(`tab-sanc-${tId}`);
    const content = $(`sanc-${tId}`);
    if (tabBtn) tabBtn.classList.toggle("active", tId === tab);
    if (content) {
      content.style.display = tId === tab ? "block" : "none";
      if (tId === tab) content.classList.add("active");
    }
  });
}

function releaseThoughtIntoMist() {
  const input = $("defusion-input");
  const cloud = $("mist-cloud-display");
  if (!input || !cloud) return;
  const thought = input.value.trim();
  if (!thought) {
    showToast(State.lang === "hi" ? "कृपया एक विचार दर्ज करें" : "Please type a thought first", "info");
    return;
  }

  cloud.textContent = `"${thought}"`;
  cloud.classList.remove("dissolving");

  setTimeout(() => {
    cloud.classList.add("dissolving");
    playCalmTone(528, 0.4);
    setTimeout(() => {
      cloud.textContent = State.lang === "hi"
        ? "✦ विचार शांत आकाश में विलीन हो गया। आप इस क्षण सुरक्षित हैं।"
        : "✦ The thought has dissolved into open space. You are safe in this moment.";
      cloud.classList.remove("dissolving");
      input.value = "";
      showToast(State.lang === "hi" ? "विचार विलीन हो गया" : "Thought released into calm", "success");
    }, 1200);
  }, 300);
}

let tippTimerInterval = null;
function startTippTimer(type, seconds) {
  clearInterval(tippTimerInterval);
  const badge = $(`timer-badge-${type}`);
  let rem = seconds;
  if (!badge) return;

  badge.textContent = `${rem}s remaining...`;
  badge.style.background = "rgba(168, 85, 247, 0.4)";

  tippTimerInterval = setInterval(() => {
    rem--;
    if (rem > 0) {
      badge.textContent = `${rem}s remaining...`;
    } else {
      clearInterval(tippTimerInterval);
      badge.textContent = `${seconds}s Timer`;
      badge.style.background = "rgba(168, 85, 247, 0.18)";
      playCalmTone(432, 0.5);
      showToast(
        State.lang === "hi"
          ? "व्यायाम पूर्ण! अपनी धीमी होती धड़कन और शांति को महसूस करें।"
          : "Exercise complete! Notice your breathing slowing and returning to balance.",
        "success",
        5000
      );
    }
...
let bilateralActive = false;
let bilateralStep = 0;

function toggleBilateralPacer() {
  const btn = $("btn-toggle-tapping");
  const padLeft = $("tap-pad-left");
  const padRight = $("tap-pad-right");

  if (bilateralActive) {
    clearInterval(bilateralInterval);
    bilateralActive = false;
    if (btn) btn.innerHTML = `<span>${State.lang === "hi" ? "शुरू करें" : "Start Pacer"}</span>`;
    if (padLeft) padLeft.classList.remove("active");
    if (padRight) padRight.classList.remove("active");
  } else {
    bilateralActive = true;
    if (btn) btn.innerHTML = `<span>${State.lang === "hi" ? "रोकें" : "Stop Pacer"}</span>`;
    bilateralStep = 0;
    ...
    step();
    bilateralInterval = setInterval(step, 1100);
  }
}

function playCalmTone(freq = 432, duration = 0.5) {
  try {
...
// ────────────────────────────────────────────────────────────────
// IN-APP AUTH & SESSION RESTORE MODAL
// ────────────────────────────────────────────────────────────────
function openAuthModal() {
  const modal = $("auth-modal");
  if (modal) modal.classList.add("visible");
  const input = $("modal-token-input");
  if (input && State.token && !input.value) input.value = State.token;
}
...
async function handleInAppTokenRestore(e) {
  e.preventDefault();
  const input = $("modal-token-input");
  const token = input.value.trim().toUpperCase();
  if (!token) return;

  const btn = $("btn-modal-restore");
  btn.disabled = true;
  btn.innerHTML = `<span>${State.lang === "hi" ? "सत्यापित हो रहा है..." : "Verifying..."}</span>`;
  ...
  try {
    ...
    showToast(
      State.lang === "hi"
        ? `सत्र सफलतापूर्वक बहाल: ${data.alias}`
        : `Session restored: ${data.alias}`,
      "success"
    );
    updateHome();
    updateProfile();
  } catch (err) {
    showToast(err.message || "Failed to restore token", "error", 4000);
  } finally {
    btn.disabled = false;
    btn.innerHTML = `<span>${State.lang === "hi" ? "सत्र बहाल करें" : "Restore Session"}</span>`;
  }
}

async function generateNewSessionPrompt() {
  try {
    const data = await apiRequest("/api/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    if (data.token) {
      ...
      closeAuthModal();
      showToast(
        State.lang === "hi" ? "नया सुरक्षित टोकन तैयार किया गया!" : "New private session created!",
        "success"
      );
      updateHome();
      updateProfile();
    ...
    showToast("Could not generate session", "error");
  }
}
...
function copyToken() {
  ...
  navigator.clipboard
    ...
    .then(() => showToast(t("toast_copied"), "info"));
}
...
async function loadForum() {
  ...
  try {
    const data = await apiRequest("/api/forum");
    const activeLanguage = State.forumLang || "en";
    renderForum(
      (data.posts || []).filter(
        (post) => (post.lang || "en") === activeLanguage,
      ),
    );
    updateForumTabs();
  } catch {
...
async function reactPost(postId, reaction) {
  try {
    const data = await apiRequest(`/api/forum/${postId}/react`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function loadCounselorQueue() {
  ...
  try {
    const data = await apiRequest("/api/counselor/queue");
...
async function markReviewed(caseId) {
  try {
    await apiRequest(`/api/counselor/review/${caseId}`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({}),
    });
...
// ────────────────────────────────────────────────────────────────
function init() {
  // The Android wrapper can supply a native navigation bar and secure token
  // bridge without changing the browser layout.
  ...
  if (!State.consent) {
    ...
    State.token = Array.from(crypto.getRandomValues(new Uint8Array(8)))
...
window.switchSanctuaryTab = switchSanctuaryTab;
window.releaseThoughtIntoMist = releaseThoughtIntoMist;
window.startTippTimer = startTippTimer;
window.toggleBilateralPacer = toggleBilateralPacer;
window.openAuthModal = openAuthModal;
window.closeAuthModal = closeAuthModal;
window.handleInAppTokenRestore = handleInAppTokenRestore;
window.generateNewSessionPrompt = generateNewSessionPrompt;
window.AegisMindApi = { request: apiRequest };
